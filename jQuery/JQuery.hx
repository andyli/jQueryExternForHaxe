...
extern class JQuery implements ArrayAccess<Node> {	
	...
	**/
	@:overload(function(elements:NodeList):JQuery{})
	@:overload(function(element:Node):JQuery{})
	@:overload(function(j:JQuery):JQuery{})
	@:overload(function(selector:String, context:Node):JQuery{})
	@:overload(function(selector:String, context:Document):JQuery{})
	@:overload(function(selector:String, context:JQuery):JQuery{})
	public function add(selectorOrHtml:String):JQuery;

	/**
		Adds the specified class(es) to each of the set of matched elements.
	**/
	@:overload(function(func:Int->String->Void):JQuery{})
	public function addClass(className:String):JQuery;

	/**
		Insert content, specified by the parameter, after each element in the set of matched elements.
	**/
	@:overload(function(content:Node):JQuery{})
	@:overload(function(content:NodeList):JQuery{})
	@:overload(function(content:JQuery):JQuery{})
	@:overload(function(content:Array<Node>):JQuery{})
	@:overload(function(content:Array<JQuery>):JQuery{})
	@:overload(function(content:Int->String):JQuery{})
	@:overload(function(content:Int->Node):JQuery{})
	@:overload(function(content:Int->NodeList):JQuery{})
	@:overload(function(content:Int->JQuery):JQuery{})
	public function after(content:String):JQuery;
	...
	**/
	inline public function closestMulti(selectors:Dynamic, ?context:Dynamic):Array<{selector:String, elem:Node}> {
...
extern class JQueryStatic {
	...
	**/
	static public function contains(container:Node, contained:Node):Bool;

	/**
		Store arbitrary data associated with the specified element.
	**/
	static public function data(ele:Node, key:String, ?value:Dynamic):Dynamic;

	/**
		Execute the next function on the queue for the matched element.
	**/
	static public function dequeue<T:Node>(ele:Node, ?queueName:String):JQuery;
	...
	**/
	static public function isXMLDoc(obj:Node):Bool;

	/**
		Determine whether the argument is a window.
	**/
	static public function isWindow(obj:Node):Bool;
	...
	**/
	static public function pushStack<T:Node>(elements:Array<Dynamic>, ?name:String, ?arguments:Dynamic):JQuery;

	/**
		Show the queue of functions to be executed on the matched element.
	**/
	static public function queue(element:Node, ?queueName:Dynamic, newQueue:Dynamic):Dynamic;

	/**
		Remove a previously-stored piece of data.
	**/
	static public function removeData<T:Node>(element:Node, ?name:String):JQuery;
